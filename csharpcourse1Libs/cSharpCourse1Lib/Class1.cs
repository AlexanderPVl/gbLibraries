...
namespace cSharpCourse1Lib
{
    public class cSharpCourse1Lib
    {
    }

    public class arrayFuncs{ //usefulMethods
        public static int countPairsWithProperty<T>(T[] arr, Func<T, T, bool> pred){ // counts number of pairs of subsequent elements that satisfy a property
            int cnt = 0;
        ...
        public static int countWithProperty<T>(T[] arr, Func<T, bool> pred){ // counts number of elements that satisfy a property
            int cnt = 0;
    ...
    public class intArray1D{
        ...
        public int maxCount(){ // returns number of elements equal to the maximum element
            ...
            return arrayFuncs.countWithProperty(arr, a => a == mx);
        }
